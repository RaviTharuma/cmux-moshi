...
Using or contributing to this repository constitutes acceptance of:
...
Any compromise, outage, billing event, or malicious update in that chain is
solely your risk. We disclaim all responsibility for:

- crates.io / Cargo dependencies and lockfile drift
- GitHub-hosted runners, Actions, caches, and artifacts
- Prebuilt release binaries and community mirrors
...
not limited to cloud providers, GitHub Actions minutes, package bandwidth,
Cursor or other AI agent usage, LLM APIs, or hosting — whether caused by
...
1. You have the right to submit the material under the MIT License.
2. Your submission is not knowingly malicious, backdoored, or unlawfully
   obtained.
3. You will not intentionally waste maintainer or infrastructure resources.
4. Maintainers may ignore, reject, revert, or rewrite your submission for any
   reason or no reason, without liability.
5. **Merge or acceptance of a contribution does not mean the maintainers
   audited it, endorse it, or accept liability for it.** Review is best-effort
   only and may miss malware or defects entirely.
6. To the maximum extent permitted by law, **you indemnify and hold harmless**
   the authors, copyright holders, and maintainers against claims, damages,
